...
instance Print Constraint where
  prt i e = case e of
   Constraint lexps -> prPrec i 0 (concatD [doc (showString "[") , prt 0 lexps , doc (showString "]")])
...
instance Print Super where
  prt i e = case e of
   ...
   SuperArrow modids sexp -> prPrec i 0 (concatD [doc (showString "->") , prt 0 modids , prt 0 sexp])
...
instance Print SExp where
  prt i e = case e of
   ...
   SExpIdent id -> prPrec i 5 (concatD [prt 0 id])
