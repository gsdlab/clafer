...
python spl_configurator/py_src/SPL_Configurator_clafer_generator.py --property=performance --sparseintegers spl_configurator/dataset/telematics_multi_objective_optimization.xml >> spl_configurator/dataset/telematics_multi_objective_optimization.als 
