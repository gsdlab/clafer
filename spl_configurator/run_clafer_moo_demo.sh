...
python py_src/SPL_Configurator_clafer_generator.py --sparseintegers dataset/telematics_multi_objective_optimization.xml >> dataset/telematics_multi_objective_optimization.als 
