...
3. `cd <cabal's lib or share folder>`  (`C:\Users\<user>\AppData\Roaming\cabal\i386-windows-ghc-7.6.3\clafer-0.3.7` on Windows or `.cabal/share/x86_64-linux-ghc-7.6.3/clafer-0.3.7/` on Linux)
