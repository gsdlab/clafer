/*
All clafers: 27 | Abstract: 3 | Concrete: 22 | References: 2
Constraints: 7
Goals: 0
Global scope: 1..*
...
open util/integer
pred show {}
run  show for 1 but 1 c10_kind, 1 c17_authors, 1 c1_Book, 1 c2_title, 2 c41_Person, 2 c42_name, 2 c45_books, 1 c4_year, 2 c5_page, 1 c6_format
...
one sig c55_GenerativeProgramming extends c1_Book
{}
...
one sig c90_Czarnecki extends c44_Author
{}
{ ((this.@r_c42_name.@ref) = 0) && (c55_GenerativeProgramming in (this.(@r_c45_books.@ref))) }

one sig c98_Eisenecker extends c44_Author
{}
{ ((this.@r_c42_name.@ref) = 0) && (c55_GenerativeProgramming in (this.(@r_c45_books.@ref))) }
