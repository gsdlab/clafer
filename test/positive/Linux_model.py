...
c0_JFFS2_FS.addConstraint(some(glob(c0_MTD)));
c0_JFFS2_FS.addConstraint(implies(some(glob(c0_MTD)), some(glob(c0_CRC32))));
c0_JFFS2_FS.addConstraint(ifOnlyIf(some(join($this(), c0_JFFS2_FS_WRITEBUFFER)), some(glob(c0_HAS_IOMEM))));
...
c0_JFFS2_ZLIB.addConstraint(some(glob(c0_ZLIB_INFLATE)));
