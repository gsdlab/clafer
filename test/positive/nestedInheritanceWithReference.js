...
Constraint(equal(joinRef(join(global(c0_SystemX), c0_connections)), union(join(global(c0_SystemX), c0_con1), join(global(c0_SystemX), c0_con2))));
Constraint(equal(joinRef(join(global(c0_SystemY), c0_connections)), union(union(join(global(c0_SystemY), c0_con3), join(global(c0_SystemY), c0_con4)), join(global(c0_SystemY), c0_con5))));
