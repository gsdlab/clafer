...
{ one @r_c0_maritalStatus.this
  ...
  ((some this.@r_c0_married) || (some this.@r_c0_divorced)) => (((this.~@r_c0_maritalStatus).(@r_c0_age.@ref)) >= 5) }
...
{ one @r_c0_married.this
  (this.(@r_c0_spouse.@ref)) != ((this.~@r_c0_married).~@r_c0_maritalStatus) }
...
{}
{ (this.(@r_c0_age.@ref)) = 6
  (((this.@r_c0_maritalStatus).@r_c0_married).(@r_c0_spouse.@ref)) = c0_Bob }
