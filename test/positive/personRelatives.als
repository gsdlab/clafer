...
{ one @r_c3_maritalStatus.this
  ...
  ((some this.@r_c5_married) || (some this.@r_c7_divorced)) => (((this.~@r_c3_maritalStatus).(@r_c2_age.@ref)) >= 5) }
...
{ one @r_c5_married.this
  ...
  (this.(@r_c6_spouse.@ref)) != ((this.~@r_c5_married).~@r_c3_maritalStatus) }
...
{}
{ (this.(@r_c2_age.@ref)) = 6
  (((this.@r_c3_maritalStatus).@r_c5_married).(@r_c6_spouse.@ref)) = c11_Bob }
