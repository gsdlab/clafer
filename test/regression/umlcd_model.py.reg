...
c0_Element.addConstraint(all([decl([x = local("x")], join($this(), c0_ownedElement))], set_in($this(), joinRef(join(joinRef(x), c0_owner)))));
c0_Element.addConstraint(all([decl([x = local("x")], join($this(), c0_owner))], set_in($this(), joinRef(join(joinRef(x), c0_ownedElement)))));
c0_Property.addConstraint(all([decl([x = local("x")], join($this(), c0_owningAssociation))], set_in($this(), join(joinRef(x), c0_ownedEnd))));
c0_Property.addConstraint(all([decl([x = local("x")], join($this(), c0_datatype))], set_in($this(), join(joinRef(x), c0_ownedAttribute))));
c0_Property.addConstraint(all([decl([x = local("x")], join($this(), c0_association))], set_in($this(), joinRef(join(joinRef(x), c0_memberEnd)))));
c0_Property.addConstraint(all([decl([x = local("x")], join($this(), c0_associationEnd))], set_in($this(), join(joinRef(x), c0_qualifier))));
c0_qualifier.addConstraint(set_in(joinParent($this()), joinRef(join($this(), c0_associationEnd))));
c0_ownedLiteral.addConstraint(set_in(joinParent($this()), joinRef(join($this(), c0_enumeration))));
c0_ownedAttribute.addConstraint(set_in(joinParent($this()), joinRef(join($this(), c0_datatype))));
c0_EnumerationLiteral.addConstraint(all([decl([x = local("x")], join($this(), c0_enumeration))], set_in($this(), join(joinRef(x), c0_ownedLiteral))));
c0_Classifier.addConstraint(all([decl([x = local("x")], join($this(), c0_feature))], set_in($this(), joinRef(join(joinRef(x), c0_featuringClassifier)))));
c0_Classifier.addConstraint(all([decl([x = local("x")], join($this(), c0_powertypeExtent))], set_in($this(), joinRef(join(joinRef(x), c0_powertype)))));
c0_generalization.addConstraint(set_in(joinParent($this()), joinRef(join($this(), c0_specific))));
c0_Feature.addConstraint(all([decl([x = local("x")], join($this(), c0_featuringClassifier))], set_in($this(), joinRef(join(joinRef(x), c0_feature)))));
c0_slot.addConstraint(set_in(joinParent($this()), joinRef(join($this(), c0_owningInstance))));
c0_Slot.addConstraint(all([decl([x = local("x")], join($this(), c0_owningInstance))], set_in($this(), join(joinRef(x), c0_slot))));
c0_Generalization.addConstraint(all([decl([x = local("x")], join($this(), c0_specific))], set_in($this(), join(joinRef(x), c0_generalization))));
c0_Generalization.addConstraint(all([decl([x = local("x")], join($this(), c0_generalizationSet))], set_in($this(), joinRef(join(joinRef(x), c1_generalization)))));
c0_Association.addConstraint(all([decl([x = local("x")], join($this(), c0_memberEnd))], set_in($this(), joinRef(join(joinRef(x), c0_association)))));
c0_Association.addConstraint(implies(greaterThan(card(join($this(), c0_memberEnd)), constant(2)), set_in(joinRef(join($this(), c0_memberEnd)), join($this(), c0_ownedEnd))));
c0_ownedEnd.addConstraint(set_in(joinParent($this()), joinRef(join($this(), c0_owningAssociation))));
c0_GeneralizationSet.addConstraint(all([decl([x = local("x")], join($this(), c0_powertype))], set_in($this(), joinRef(join(joinRef(x), c0_powertypeExtent)))));
c0_GeneralizationSet.addConstraint(all([decl([x = local("x")], join($this(), c1_generalization))], set_in($this(), joinRef(join(joinRef(x), c0_generalizationSet)))));
