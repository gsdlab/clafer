...
{ all disj x, y : this.@r_c0_connections | (x.@ref) != (y.@ref) 
  (this.(@r_c0_connections.@ref)) = (this.@r_c0_Connection) }
...
assert assertOnLine_10 { (c0_SystemX.(@r_c0_connections.@ref)) = ((c0_SystemX.@r_c0_con1) + (c0_SystemX.@r_c0_con2)) }
...
assert assertOnLine_17 { (c0_SystemY.(@r_c0_connections.@ref)) = (((c0_SystemY.@r_c0_con3) + (c0_SystemY.@r_c0_con4)) + (c0_SystemY.@r_c0_con5)) }
