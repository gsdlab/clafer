...
c0_midYearReview = Clafer("c0_midYearReview").withCard(1, 1).extending(c0_Meeting);
...
c0_Steven = Clafer("c0_Steven").withCard(1, 1).extending(c0_Member);
c0_C = Clafer("c0_C").withCard(1, 1).extending(c0_Room);
...
c0_ondemandMeeting = Clafer("c0_ondemandMeeting").withCard(1, 1).extending(c0_Meeting);
c1_chair = c0_ondemandMeeting.addChild("c1_chair").withCard(1, 1);
c1_room = c0_ondemandMeeting.addChild("c1_room").withCard(1, 1);
c0_Joanna = Clafer("c0_Joanna").withCard(1, 1).extending(c0_Member);
c0_D = Clafer("c0_D").withCard(1, 1).extending(c0_Room);
...
c0_June = Clafer("c0_June").withCard(1, 1).extending(c0_Month);
c0_July = Clafer("c0_July").withCard(1, 1).extending(c0_Month);
...
c0_M = Clafer("c0_M").withCard(5, 5).extending(c0_Member);
c0_SueAgenda = Clafer("c0_SueAgenda").withCard(1, 1).extending(c0_Agenda);
c0_m1 = c0_SueAgenda.addChild("c0_m1").withCard(0, 1);
c0_m2 = c0_SueAgenda.addChild("c0_m2").withCard(0, 1);
c0_M1 = Clafer("c0_M1").withCard(0, 1).extending(c0_Meeting);
c0_M2 = Clafer("c0_M2").withCard(0, 1).extending(c0_Meeting);
c0_time = c0_M2.addChild("c0_time").withCard(1, 1);
c0_mt = c0_Agenda.addChild("c0_mt");
c0_month.refTo(c0_Month);
c0_chair.refTo(c0_Member);
c0_room.refTo(c0_Room);
c1_chair.refTo(c0_Member);
c1_room.refTo(c0_Room);
c2_chair.refTo(c0_Member);
c0_participant.refToUnique(c0_Member);
c0_onlineParticipant.refToUnique(c0_Member);
c2_room.refTo(c0_Room);
c0_capacity.refTo(Int);
c0_m1.refTo(c0_Meeting);
c0_m2.refTo(c0_Meeting);
c0_time.refTo(Int);
