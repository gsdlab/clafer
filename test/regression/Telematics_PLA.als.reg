...
{ (some (this.@r_c0_channel).@r_c0_dual) <=> (some c0_ECU2)
  (some this.@r_c0_extraDisplay) <=> ((#(c0_ECU1.@r_c1_display)) = 2)
  (some this.@r_c0_extraDisplay) <=> ((some c0_ECU2) => ((#(c0_ECU2.@r_c1_display)) = 2))
  (some (this.@r_c0_size).@r_c0_large) <=> (no (((c0_plaECU.@r_c1_display).@r_c0_options).@r_c1_size).@r_c1_small)
  (some (this.@r_c0_size).@r_c0_small) <=> (no (((c0_plaECU.@r_c1_display).@r_c0_options).@r_c1_size).@r_c1_large) }
...
sig c0_options extends c1_options
{}
{ one @r_c0_options.this }

abstract sig c1_options
{ r_c1_size : one c1_size
, r_c0_cache : lone c0_cache }
{ ((some (this.@r_c1_size).@r_c1_small) && (some this.@r_c0_cache)) => (some ((this.@r_c0_cache).@r_c2_size).@r_c0_fixed) }
...
{ one @r_c1_display.this
  (this.(@r_c0_server.@ref)) = (this.~@r_c1_display)
  no (this.@r_c0_options).@r_c0_cache }
...
fact { some (c0_telematicsSystem.@r_c0_channel).@r_c0_dual }
fact { some c0_telematicsSystem.@r_c0_extraDisplay }
fact { some (c0_telematicsSystem.@r_c0_size).@r_c0_large }
fact { (c0_comp.(@r_c0_version.@ref)) = 1 }
