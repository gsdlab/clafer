...
c0_y.refTo(c0_x);
c0_z.refTo(c0_y);
Constraint(equal(joinRef(global(c0_x)), constant(1)));
Constraint(equal(joinRef(global(c0_x)), constant(1)));
Constraint(equal(joinRef(joinRef(global(c0_y))), constant(1)));
Constraint(equal(joinRef(joinRef(global(c0_y))), constant(1)));
Constraint(equal(joinRef(joinRef(global(c0_y))), constant(1)));
Constraint(equal(joinRef(joinRef(joinRef(global(c0_z)))), constant(1)));
Constraint(equal(joinRef(joinRef(joinRef(global(c0_z)))), constant(1)));
Constraint(equal(joinRef(joinRef(joinRef(global(c0_z)))), constant(1)));
Constraint(equal(joinRef(joinRef(joinRef(global(c0_z)))), constant(1)));
