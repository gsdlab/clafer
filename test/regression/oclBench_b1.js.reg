...
Constraint(equal(joinRef(join(joinRef(global(c0_adaBobCyd)), c0_name)), joinRef(global(c0_stringSet1))));
Constraint(equal(joinRef(join(joinRef(global(c0_personWithUndefinedHusband1)), c0_name)), joinRef(global(c0_stringSet2))));
Constraint(equal(joinRef(join(joinRef(global(c0_personWithUndefinedHusband2)), c0_name)), joinRef(global(c0_stringSet2))));
Constraint(and(equal(joinRef(join(joinRef(join(joinRef(global(c0_possiblePairs)), c0_first)), c0_name)), constant("\"Ada\"")), equal(joinRef(join(joinRef(join(joinRef(global(c0_possiblePairs)), c0_second)), c0_name)), constant("\"Bob\""))));
Constraint(all([decl([p = local("p")], global(c0_Person))], implies($in(joinRef(join(p, c0_name)), joinRef(global(c0_stringSet1))), $in(p, joinRef(global(c0_adaBobCyd))))));
Constraint(all([decl([p = local("p")], global(c0_Person))], implies(equal(joinRef(join(p, c0_husband)), joinRef(global(c0_emptyPersonSet1))), $in(p, joinRef(global(c0_personWithUndefinedHusband1))))));
Constraint(all([decl([p = local("p")], global(c0_Person))], implies(equal(joinRef(join(p, c0_husband)), joinRef(global(c0_emptyPersonSet2))), $in(p, joinRef(global(c0_personWithUndefinedHusband2))))));
Constraint(all([decl([p = local("p")], global(c0_Person))], implies(none(join(p, c0_wife)), $in(p, joinRef(global(c0_personWithNoWife))))));
Constraint(equal(joinRef(global(c0_emptyPersonSet1)), joinRef(join(joinRef(global(c0_personWithNoWife)), c0_wife))));
Constraint(all([decl([p = local("p"), q = local("q")], global(c0_Person))], implies(and(and(and(and(and(equal(joinRef(join(p, c0_gender)), constant("\"female\"")), some(join(p, c0_alive))), notEqual(joinRef(join(p, c0_civstat)), constant("\"married\""))), equal(joinRef(join(q, c0_gender)), constant("\"male\""))), some(join(q, c0_alive))), notEqual(joinRef(join(q, c0_civstat)), constant("\"married\""))), one([decl([pair = local("pair")], global(c0_personPair))], and(and(equal(joinRef(join(pair, c0_first)), p), equal(joinRef(join(pair, c0_second)), q)), $in(pair, joinRef(global(c0_possiblePairs))))))));
...
c0_Person.addConstraint(all([decl([p = local("p")], global(c0_Person))], implies(notEqual($this(), p), notEqual(joinRef(join($this(), c0_name)), joinRef(join(p, c0_name))))));
c0_Person.addConstraint(one([decl([p = local("p")], global(c0_Person))], equal(joinRef(join(p, c0_name)), joinRef(join($this(), c0_name)))));
c0_husband.addConstraint($in(joinParent($this()), joinRef(join(joinRef($this()), c0_wife))));
c0_wife.addConstraint($in(joinParent($this()), joinRef(join(joinRef($this()), c0_husband))));
...
c0_eve.addConstraint(and(and(and(and(and(equal(joinRef(join($this(), c0_name)), constant("\"Eve\"")), equal(joinRef(join($this(), c0_civstat)), constant("\"married\""))), equal(joinRef(join($this(), c0_gender)), constant("\"female\""))), some(join($this(), c0_alive))), equal(joinRef(join($this(), c0_husband)), global(c0_dan))), none(join($this(), c0_wife))));
...
c0_dan.addConstraint(and(and(and(and(and(equal(joinRef(join($this(), c0_name)), constant("\"Dan\"")), equal(joinRef(join($this(), c0_civstat)), constant("\"married\""))), equal(joinRef(join($this(), c0_gender)), constant("\"male\""))), some(join($this(), c0_alive))), none(join($this(), c0_husband))), equal(joinRef(join($this(), c0_wife)), global(c0_eve))));
c0_adaBobCyd.addConstraint($in(joinRef(join(joinRef($this()), c0_name)), joinRef(global(c0_stringSet1))));
c0_personWithUndefinedHusband1.addConstraint(equal(joinRef(join(joinRef($this()), c0_husband)), joinRef(global(c0_emptyPersonSet1))));
c0_personWithUndefinedHusband2.addConstraint(equal(joinRef(join(joinRef($this()), c0_husband)), joinRef(global(c0_emptyPersonSet2))));
