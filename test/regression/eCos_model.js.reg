...
c0_CYGPKG_FS_JFFS2.addConstraint(some(global(c0_CYGPKG_CRC)));
c0_CYGPKG_FS_JFFS2.addConstraint(some(global(c0_MTD)));
c0_CYGPKG_FS_JFFS2.addConstraint(ifOnlyIf(some(join($this(), c0_CYGOPT_FS_JFFS2_NAND)), some(global(c0_HAS_IOMEM))));
...
c0_CYGOPT_FS_JFFS2_COMPRESS_ZLIB.addConstraint(some(global(c0_CYGPKG_COMPRESS_ZLIB)));
